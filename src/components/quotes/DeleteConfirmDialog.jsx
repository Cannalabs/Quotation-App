        ...
        <AlertDialogHeader>
          <div className="flex items-center gap-3 mb-2">
            ...
            <AlertDialogTitle className="text-xl font-bold text-slate-800">
              {isBulk ? `Delete ${quoteCount} Quotations?` : `Delete Quotation ${quoteName}?`}
            </AlertDialogTitle>
          </div>
          <AlertDialogDescription className="text-slate-600">
            {isBulk 
              ? `${quoteCount} quotations will be moved to trash. This can be undone from the Trash tab.`
              : `Quotation ${quoteName} will be moved to trash. This can be undone from the Trash tab.`
            }
          </AlertDialogDescription>
        </AlertDialogHeader>
